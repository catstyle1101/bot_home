...
class NNMClub:
    ...
    def search(self, text, max_pages=1):
        ...
        search_data = {'nm': text.encode('cp1251'), 'shr': 1, 'sht': 1}  # shr shows rating column; sht shows thanks column !!! вот тут добавил кодировку в 1251 тогда кириллица и заработала
        #print(search_data)
